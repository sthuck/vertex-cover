...
from algorithms.reductions.joint_neighbors import remove_vertices_with_2_joint_neighbors
...
def reduce_graph(graph: Graph, do_reduce_1=True, do_reduce_2=True, do_reduce_3=True, counters: ReductionCounters = None):
    ...
    while True:
        ...
        if do_reduce_3:
            how_many_removed = remove_vertices_with_2_joint_neighbors(graph)
            if how_many_removed > 0:
                reduce_3_worked = True
            counter_of_removed += how_many_removed
            if counters:
                counters.reduction_3_counter += how_many_removed
